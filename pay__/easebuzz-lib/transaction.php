<?php
    ...
    */
    function _transaction($params, $merchant_key, $salt, $env){
        ...
        if(strlen($temp[0]) == 0){
         ...
         elseif( strlen($temp[0])==1 || strlen($temp[0])==2 ){
    ...
    */
    function _validateTransactionResponse($response_array, $salt_key){
        ...
        if (isset($response_array->status) == 1){
            ...
            if($reverse_hash_key === isset($response_array->data->hash)){
